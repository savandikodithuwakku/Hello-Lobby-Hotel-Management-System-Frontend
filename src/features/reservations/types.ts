/**
 * The reservation module's own types, labels and small helpers.
 *
 * Filter shapes, status wording and the advance-payment maths all belong to
 * this feature, so they live together rather than in a constants file of
 * their own.
 */
