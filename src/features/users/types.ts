/**
 * The user module's own types, labels and small helpers.
 *
 * Filter shapes, status wording and the address helpers belong to this
 * feature, so they live together rather than in a constants file of their own.
 */
...
import { ROLES, ROLE_LABELS } from "../auth/context/authContext.ts";
